...
class Mainwin(qtw.QWidget): #creating class will inherit from qwidget and it will perform all the elements
    def __init__(self):
    ...
    def keypad(self): # the GUI stuffs
        ...
        #button lists
        rf = self.result_field = qtw.QLineEdit() #it will displays the text and put it in a variable called result_field
        btn_result = qtw.QPushButton(' ', clicked = self.func_result)
        btn_clear = qtw.QPushButton(' ', clicked = self.clear_calc)
        btn_9 = qtw.QPushButton(' ', clicked = lambda:self.num_press('9'))
        btn_8 = qtw.QPushButton(' ', clicked = lambda:self.num_press('8'))
        btn_7 = qtw.QPushButton(' ', clicked = lambda:self.num_press('7'))
        btn_6 = qtw.QPushButton(' ', clicked = lambda:self.num_press('6'))
        btn_5 = qtw.QPushButton(' ', clicked = lambda:self.num_press('5'))
        btn_4 = qtw.QPushButton(' ', clicked = lambda:self.num_press('4'))
        btn_3 = qtw.QPushButton(' ', clicked = lambda:self.num_press('3'))
        btn_2 = qtw.QPushButton(' ', clicked = lambda:self.num_press('2'))
        btn_1 = qtw.QPushButton(' ', clicked = lambda:self.num_press('1'))
        btn_0 = qtw.QPushButton(' ', clicked = lambda:self.num_press('0'))
        ...
        container.layout().addWidget(self.result_field,0,0,1,4) #self is to touch the result field with the widgets inside it
